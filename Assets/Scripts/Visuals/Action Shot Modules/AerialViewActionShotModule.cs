...
public class AerialViewActionShotModule : FleetAttackFormationBaseModule
{
    ...
    public override void Prepare()
    {
        ...
        Vector3 targetCameraPosition = Vector3.Lerp(fleetPosition, BattleInterface.battle.recentAttackInfo.hitTiles[0].transform.position, 0.5f);
        ...
        foreach (Ship ship in attackers)
        {
            ...
            float time = ship.PrepareToFireAt(BattleInterface.battle.recentAttackInfo.hitTiles[0].transform.position, BattleInterface.battle.recentAttackInfo.hitShips[0]);
